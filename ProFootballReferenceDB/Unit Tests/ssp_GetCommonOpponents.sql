...
CREATE PROCEDURE Tests_ssp_GetCommonOpponents.[Test - Blank Team parameter returns no data2]
AS
BEGIN
...
CREATE PROCEDURE Tests_ssp_GetCommonOpponents.[Test - Blank Opponent parameter returns no data2]
AS
BEGIN
	INSERT INTO Tests_ssp_GetCommonOpponents.Actual
	(
